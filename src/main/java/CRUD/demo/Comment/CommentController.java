...
public class CommentController {
    ...
    public ResponseEntity save(@ModelAttribute CommentDto commentDto,
        ...
        Long memberSequence = userDetails.getMember().getMemberSequence();
        commentDto.setMemberSequence(memberSequence);
    ...
    public ResponseEntity<List<CommentDto>> getComments(@PathVariable Long boardSequence) {
        // 주어진 boardId에 해당하는 게시글의 댓글 목록을 조회
        List<CommentDto> commentList = commentService.getCommentsByBoardId(boardSequence);
        // 댓글 목록과 서버 ok 응답
    ...
    public ResponseEntity<CommentDto> deleteComment(@PathVariable Long commentId,
        ...
        try {
            Comment deletedComment = commentService.deleteComment(commentId, memberSequence);
    ...
    public ResponseEntity<CommentDto> updateComment(@PathVariable Long commentId,
        ...
        Long memberSequence = userDetails.getMember().getMemberSequence();
        Comment updatedComment = commentService.updateComment(commentId, contents, memberSequence);
