...
//                boardPostRepository.findById(commentDto.getBoardPostSequence());
...
//    public List<CommentDto> getCommentsByBoardId(Long boardPostSequence) {
//        List<Comment> commentList = commentRepository.findByBoardPost_BoardPostSequence(boardPostSequence);
...
//    // 특정 댓글 업데이트
//    @Transactional
//    public Comment updateComment(Long Id, String contents, Long memberSequence) {
//        // commentId를 이용하여 업데이트 할 댓글을 조회
//        Optional<Comment> optionalComment =
//                commentRepository.findById(Id);
//        Optional<Member> optionalUser =
//                memberRepository.findByMemberSequence(memberSequence);
...
//            if(member.getMemberSequence().equals(Id)){
